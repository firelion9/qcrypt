...
sealed class DilithiumParams(
    ...
    val CRYPTO_PUBLIC_KEY_BYTES = SEED_BYTES + K * POLYNOMIAL_T1_PACKED_BYTES

    val CRYPTO_PRIVATE_KEY_BYTES =
        3 * SEED_BYTES + L * POLYNOMIAL_ETA_PACKED_BYTES + K * POLYNOMIAL_ETA_PACKED_BYTES + K * POLYNOMIAL_T0_PACKED_BYTES

    val SIGNATURE_BYTES = SEED_BYTES + L * POLYNOMIAL_Z_PACKED_BYTES + POLYNOMIAL_VECTOR_H_PACKED_BYTES
